    ...
    public class Kiyaslaİnitializer : DropCreateDatabaseIfModelChanges<KiyaslaContext>
    {
        protected override void Seed(KiyaslaContext context)
        {
            var Phones = new List<Phone> 
                {
                    new Phone{ TelefonMarkasi="Blackberry",TelefonModeli="Z30",MarkaModel="Blackberry Z30",RAM=3,Ekrancözünürlügü="1920x1080",ArkaKamerapixel=8,ÖnKamerapixel=2,İslemciMarkasi="Qualcomm Snapdragon",İslemciModeli="615",İslemciHizi_Ghz=2.1,İslemciCekirdek=4,GrafikİslemciModeli="Mali-450",GrafikİslemciHizi_Mhz=564,DahiliDepolama_GB=64,MicroSdVarmi=false,Batarya_Mh=2500,Agırlık_Gram=215,Renk="Black",İsletimSistemi="Blackberry OS",SistemSürümü="10.1.2",Fotograf="/Folder/Plugin/Site/Phone/Blackberry/BlackberryZ30.jpg"},                   
