<%@ Page Title="" Language="C#" MasterPageFile="~/Folder/MasterPage/Admin.Master" AutoEventWireup="true" CodeBehind="Detay.aspx.cs" Inherits="kiyas.la.Admin.Detay" %>
<asp:Content ID="Content1" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    ...
    <asp:CheckBox ID="MicroSdVarmiCheckbox" runat="server" class="text-danger" Text="&nbsp&nbsp Micro Sd Var mi ?"/><br /><br />
